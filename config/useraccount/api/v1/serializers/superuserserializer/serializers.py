...
class UserAccountCreationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserAccount
        fields = ['id', 'full_name', 'username', 'email', 'password', 'confirm_password', 'last_login', 'is_superuser', 'is_staff', 'is_active', 'date_joined', 'is_account_verified']
...
class UserAccountUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserAccount
        fields = ['id', 'full_name', 'username', 'email', 'profile_picture', 'background_picture', 'is_private', 'last_login', 'is_superuser', 'is_staff', 'is_active', 'date_joined', 'is_account_verified', 'new_email', 'is_new_email_verified']
...
class UserAccountRetrivalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserAccount
        fields = ['id', 'full_name', 'username', 'email', 'profile_picture', 'background_picture', 'is_private', 'last_login', 'is_superuser', 'is_staff', 'is_active', 'date_joined', 'is_account_verified', 'new_email', 'is_new_email_verified', 'otp_object']
